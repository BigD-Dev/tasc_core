DROP TABLE IF EXISTS tasc_sandbox.tasc_apparel_fabric_ruleset CASCADE;
CREATE TABLE tasc_sandbox.tasc_apparel_fabric_ruleset (
    asof_dt DATE,
    outerwear VARCHAR(255),
    top_2_2nd_layer VARCHAR(255),
    top_1_1st_layer VARCHAR(255),
    bottoms VARCHAR(255),
    socks VARCHAR(255),
